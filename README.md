...
- [Client API documentation - GoDoc](https://godoc.org/github.com/tejas456sawant/gokiteconnect)
- [Kite Connect HTTP API documentation](https://kite.trade/docs/connect/v3)

## Installation

```
go get github.com/tejas456sawant/gokiteconnect/v4
```
...
import (
	...
	kiteconnect "github.com/tejas456sawant/gokiteconnect/v4"
)
...
import (
	...
	kiteconnect "github.com/tejas456sawant/gokiteconnect/v4"
	kitemodels "github.com/tejas456sawant/gokiteconnect/v4/models"
	kiteticker "github.com/tejas456sawant/gokiteconnect/v4/ticker"
)
...
Check [examples folder](https://github.com/tejas456sawant/gokiteconnect/tree/master/examples) for more examples.
